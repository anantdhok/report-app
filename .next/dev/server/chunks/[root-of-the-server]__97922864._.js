...
async function POST(req) {
    try {
        ...
        const requestBy = body?.requestBy;
        if (!targetId) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].reportJob.create({
            data: {
                id: requestId,
                targetId,
                status: "queued",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97922864._.js.map