...
async function POST(req) {
    try {
        ...
        // Ensure arrays exist
        reportPayload.smsRecordsDetailedTable ??= {
            rows: []
        };
        reportPayload.whatsappRecordsDetailedTable ??= {
            rows: []
        };
        reportPayload.emailRecordsDetailedTable ??= {
            rows: []
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba85a084._.js.map