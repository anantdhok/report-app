...
async function POST(req) {
    try {
        ...
        const templatePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), "src/views/report.ejs");
        let fullHTML = "";
        for(let i = 0; i < totalChunks; i++){
            const chunk = records.slice(i * chunkSize, (i + 1) * chunkSize);
            const chunkHTML = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ejs$2f$lib$2f$ejs$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].renderFile(templatePath, {
                payload: chunk
            });
            fullHTML += chunkHTML;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b92c4797._.js.map